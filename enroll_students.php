																				...
																				<div class="dropdown pull-left">
																					...
																					<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dLabel">
																						...
																						<li><a href="<?php echo tep_href_link(FILENAME_NSDC_UPLOAD_STATUS,tep_get_all_get_params(array('msg','actionType','int_id','stud_id'))."actionType=edit&int_id=".$listing['student_id']); ?>">Update NSDC Upload Status</a></li>
                                                                                                                                                                                <li><a href="<?php echo tep_href_link(FILENAME_NSDC_UPLOAD_STATUS,tep_get_all_get_params(array('msg','actionType','int_id','stud_id'))."actionType=edit&int_id=".$listing['student_id']); ?>">Update MOMA Upload Status</a></li>
																						...
																						<li><a href="<?php echo tep_href_link(FILENAME_STIPEND_ALLOWANCE,tep_get_all_get_params(array('msg','actionType','int_id','stud_id'))."actionType=edit&int_id=".$listing['student_id']); ?>">Update Stipend Status</a></li>
