										...
										<td valign="top">
											<?php
												if($_GET['actionType'] == "edit")
												{
													...
													$info_query_raw = "select student_id, centre_id, course_id, placement_alw_amt_paid, date_format(placement_alw_date, '%d-%m-%Y') as placement_alw_date, placement_alw_mop, placement_alw_installment, placement_alw_remarks from " . TABLE_STUDENTS . " where student_id='" . $int_id . "' ";
