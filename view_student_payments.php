<?php	
	...
	if(isset($action) && tep_not_null($action))
	{
		...
		switch($action){
			case 'update_payment_mode':
				...
				tep_db_perform(TABLE_STUDENT_PAYMENTS, $stud_payment_db_values, "update", "stud_payment_id = '" . $stud_payment_id . "' and centre_id = '" . $centre_id . "'");
				...
				if($generate_receipt == '1'){
					...
					$receipts_db_values = array(
						...
						'receipt_amount' => $sp_info_array['stud_payment_amount'],
						'receipt_created' => 'now()'
					);
			...
			case 'settle_payment_mode':
				...
				$stud_payment_db_values = array(
					...
					'stud_payment_amount' => $sp_info_array['stud_payment_amount'],
	...
	$student_payments_query_raw = "select sp.stud_payment_id, sp.student_id, sp.deposit_id, sp.stud_payment_type, sp.stud_payment_mode, sp.stud_payment_cheque_no, sp.stud_payment_bank_name, sp.stud_payment_bank_branch, date_format(sp.stud_payment_deposit_date, '%d-%m-%Y') as stud_payment_deposit_date, sp.stud_payment_receipt_no, sp.is_auto_generated_reciept, sp.stud_payment_amount, sp.stud_payment_status, sp.stud_payment_added, sp.cheque_cleared, i.installment_no from " . TABLE_STUDENT_PAYMENTS . " sp left join " . TABLE_INSTALLMENTS . " i on (i.installment_id = sp.installment_id)  where sp.student_id='" . $int_id . "' ";//and stud_payment_type = 'DEPOSITED'
	if($_SESSION['sess_adm_type'] != 'ADMIN'){
																				...
																				<fieldset>
																					...
																					<table cellpadding="5" cellspacing="0" border="0" width="100%" id="payments">
																						...
																						<tbody>
																							...
																							?>
																							<tr bgcolor="<?php echo $tr_color;?>">
																								<td class="arial12LGray brdr_right brdr_left" style="border-bottom:none;" <?php echo($student_payment_info['stud_payment_mode'] == 'UNKNOWN' ? 'rowspan="2"' : '');?>>
																									<?php
																										echo $cnt_payments;
																									?>
																								</td>
																								<td class="arial12LGray brdr_right" style="border-bottom:none;">
																									<?php 
																										...
																										if($student_payment_info['installment_no'] != ''){
																							...
																							<?php
																								if($student_payment_info['stud_payment_mode'] == 'UNKNOWN'){
																							?>
																							<tr bgcolor="<?php echo $tr_color;?>">
																								<td colspan="11">
																									...
																									<table cellpadding="5" cellspacing="0">
																										<tr>
																											...
																											<td class="arial12LGrayBold <?php echo $unq_class;?>" style="display:none;">
																											...
																											<td class="arial12LGrayBold">
																												<input type="checkbox" onclick="toggle_manual_receipt();" name="generate_receipt" id="generate_receipt" value="1" checked="checked">&nbsp;<label for="generate_receipt">Generate Receipt</label>
																											</td>
																											<td class="arial12LGrayBold blk_manual_receipt">
																						...
																						<tbody>
																							...
																							<tr bgcolor="<?php echo $tr_color;?>">
																								...
																								<td class="arial12LGray brdr_right"  style="border-bottom:none; border-left:none;">
																									<?php
																										if(in_array($refund_info['refund_mode'], array('CHEQUE', 'DD', 'NEFT_RTGS'))){
																											echo (tep_not_null($refund_info['refund_bank_name']) ? $refund_info['refund_bank_name'] : '-');
																										}else{
																											echo '-';
																										}
																									?>
																								...
																								<td class="arial12LGray brdr_right"  style="border-bottom:none; border-left:none;">
																									<?php 
																										if(in_array($refund_info['refund_mode'], array('CHEQUE', 'DD', 'NEFT_RTGS'))){
																											echo (tep_not_null($refund_info['refund_branch_name']) ? $refund_info['refund_branch_name'] : '-');
																										}else{
																											echo '-';
																										}
																									?>
																								...
																								<td class="arial12LGray brdr_right"  style="border-bottom:none; border-left:none;">
																									<?php 
																										echo (tep_not_null($refund_info['refund_reason']) ? $refund_info['refund_reason'] : '-');
																									?>
																								</td>
																								<td class="arial12LGray brdr_right"  style="border-bottom:none; border-left:none;">
																									<?php 
																										echo (tep_not_null($refund_info['refund_review']) ? $refund_info['refund_review'] : '-');
																									?>
																								</td>
																								<td class="arial12LGray brdr_right"  style="border-bottom:none; border-left:none;">
																									<?php 
																							...
																							<?php }else{ ?>
																							<tr>
																								<td colspan="8" class="arial12LGray" align="center">No refund available.</td>
																							</tr>
																							<?php } ?>
																						<tbody>
																					</table>
