										...
										<td valign="top">
											<?php
												if($_GET['actionType'] == "edit")
												{
													...
													$info_query_raw = "select student_id, centre_id, course_id, non_res_alw_amt_paid, date_format(non_res_alw_date, '%d-%m-%Y') as non_res_alw_date, non_res_alw_mop, non_res_alw_installment, non_res_alw_remarks from " . TABLE_STUDENTS . " where student_id='" . $int_id . "' ";
													...
													$installment_query_raw = "select installment_id, student_id, installment_type, installment_no, date_format(installment_date, '%d-%m-%Y') as installment_date, installment_mop, instrument_no, installment_amount, is_receipt_collected, receipt_filename, is_cheque_cleared, date_format(cheque_cleared_date, '%d-%m-%Y') as cheque_cleared_date from " . TABLE_INSTALLMENTS . " where student_id='" . $int_id . "' and installment_type = 'NON_RES_ALLOWANCE' order by installment_no";
